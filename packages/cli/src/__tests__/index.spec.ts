    ...
    [
      {
        ...
        result: {
          ...
          price: 790000,
          description: [
            "<p>Na sprzedaż piękna działka budowlana, o powierzchni 500 m² położona blisko kolejki WKD w Komorowie. Działka ma przeznaczenie usługowo-mieszkaniowe. Dostępny procent zabudowy wynosi 30%.</p><p>Jest to ostatnia działka położona w tak znakomitej lokalizacji. Znajduje się bowiem ok. 1 min. pieszo do stacji WKD Komorów, a co za tym idzie do całej infrastruktury. W pobliżu są sklepy, usługi, cukiernie, restauracje, przychodnia, apteka, przedszkola prywatne, kompleks szkół. W okolicy jest dostępny także Zalew Komorów na rzece Utracie, który jest rajem dla wędkarzy i ptaków.</p><p>Działka położona jest przy cichej ulicy. Dookoła dominuje zabudowa jednorodzinna. Media są w drodze, aczkolwiek na działce znajduje się studnia głębinowa. Warto wspomnieć, że są tu niskie wody gruntowe, zatem można wybudować dom jednorodzinny podpiwniczony. </p><p>Ponieważ przeznaczenie działki jest pod zabudowę usługowo-mieszkaniową, zatem na parterze mogą być usługi, a do II piętra część mieszkaniowa. Dozwolona jest wysokość zabudowy do 12 m².</p><p>Zapraszam zainteresowanych do kontaktu.</p><p></p><p></p><p></p>",
          ],
          parameters: [],
          address: {
            lokalizacja_gmina: "Komorów",
            lokalizacja_region: "mazowieckie",
            lokalizacja_powiat: "powiat-pruszkowski",
